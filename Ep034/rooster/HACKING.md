...
hidden if the `Rooster_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `Rooster_DEVELOPER_MODE` to the configure
...
Runs the executable target `Rooster_exe`.
